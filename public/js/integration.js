...
const good = document.querySelector(".hide");
...
newElement.innerHTML = `<label for="${idcont1}" class="form-control my-3 mr-3 btn-info">Api name</label>` +
 `<input class="form-control my-3" type="text" name="apiNames" value="" id="${idcont1}" placeholder="Api Name" required><br>`+
 `<label for="${idcont2}" class="form-control my-3 mr-3 btn-info">Api image address</label>`+
 ...
 `<label for="${idcont3}" class="btn-info my-3 form-control mr-3">Api link address</label>`+
`<input class="form-control my-3" type="text" id="${idcont3}" name="apiAddresses" value="https//:" placeholder="Api Address" required><br>`+
`<label for="${idcont4}" class="btn-info my-3 form-control mr-3">Api company Name</label>`+
